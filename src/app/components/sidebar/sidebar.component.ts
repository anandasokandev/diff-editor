...
@Component({
    ...
    <div class="sidebar-shell">
      ...
      <!-- Content Panel -->
      <div class="content-panel" *ngIf="activeTab">
        ...
        <ng-container *ngIf="activeTab === 'templates'">
          ...
          <div class="preset-grid">
            <div class="preset-card" *ngFor="let p of presets; let i = index" (click)="cs.loadPreset(i)">
        ...
        <ng-container *ngIf="activeTab === 'text'">
          ...
          <div class="text-style-list">
            <div class="text-style-item" *ngFor="let s of textStyles" (click)="addStyledText(s)">
        ...
        <!-- SHAPES -->
        <ng-container *ngIf="activeTab === 'shapes'">
          <div class="panel-head">Shapes</div>
          <div class="section-label">Basic Shapes</div>
          <div class="shape-grid">
            <div class="shape-item" *ngFor="let s of shapes" (click)="addShape(s)" [title]="s.label">
          ...
          <div class="color-fills">
            <div class="fill-chip" *ngFor="let c of fillColors" (click)="addColorRect(c)" [style.background]="c"></div>
          </div>
        </ng-container>
        ...
        <ng-container *ngIf="activeTab === 'layers'">
          ...
          <div class="layers-info" *ngIf="!cs.elements().length">
          ...
          <div
            class="layer-item"
            *ngFor="let el of reversedElements; let i = index"
            [class.active]="el.id === cs.selectedId()"
            (click)="cs.selectedId.set(el.id)"
          >
            <div class="layer-type-icon">
              <ng-container [ngSwitch]="el.type">
                <svg *ngSwitchCase="'text'" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="4 7 4 4 20 4 20 7"/><line x1="9" y1="20" x2="15" y2="20"/><line x1="12" y1="4" x2="12" y2="20"/>
                </svg>
                <svg *ngSwitchCase="'img'" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>
                </svg>
                <svg *ngSwitchDefault width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <rect x="3" y="3" width="18" height="18" rx="2"/>
                </svg>
              </ng-container>
            </div>
            <span class="layer-name">{{ getLayerName(el) }}</span>
            <span class="layer-lock" *ngIf="el.locked">
